...
export default function OptionButton({
  ...
  let style =
    "bg-gradient-to-b from-[#1b2735] to-[#090a0f]  text-yellow-100 hover:shadow-[0_0_20px_rgba(255,215,0,0.3)] hover:scale-[1.02]";
  if (isAnswered) {
  ...
  return (
    <button
      ...
      className={`relative cursor-pointer group overflow-hidden rounded-full border-1 text-lg sm:text-xl font-bold tracking-wide flex items-center justify-center h-[70px] sm:h-[90px] transition-all duration-500 shadow-[0_0_20px_rgba(255,255,255,0.1)] ${style}`}
    ...
    >
      ...
      <span className="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-300/10 to-transparent "></span>
